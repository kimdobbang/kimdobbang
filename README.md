...
- 직관적이고 읽기에 좋은 코드를 작성하려고 노력합니다.

- 좋아하는것이 생기면 열성적으로 찾아보고 연구합니다.
...
<span style="font-weight:bold">SSAFY 삼성 청년 SW 아카데미</span>
  ...
  <div> - 11기 : 2024.01 ~ 2024.12 </div>
  <div> - Coding Track 수료 </div>
  <br>
</details>
...
| 개발      | SSAFY 기업연계 프로젝트 우수상                   | 3위   | 삼성전자                                   | 2024-11-19  |
| 개발      | SSAFY 특화 프로젝트 우수상                       | 3위  | 삼성전자                                   | 2024-10-11  |
| 개발      | SSAFY 공통 프로젝트 우수상                       | 1위  | 삼성전자                                   | 2024-08-16   |
...
**2024 SSAFY 기업연계프로젝트 우수상(3위)**
  <br> _삼성SDS - Busy Bee_ / 삼성전자 (24.11.19)

**2024 SSAFY 자율프로젝트 우수상(3위)**
  <br> _캐치캐치! 시즌아레나_ / 삼성전자 (24.10.11)

**2024 SSAFY 공통프로젝트 우수상(1위)**
...
<details>
  ...
  <ul>
    ...
    <li><b>대외협력실 인턴</b> (2021.9-2022.3)
      <ul>
        <li>Python 크롤링을 활용한 언론 모니터링 및 데이터 수집</li>
...
## 💻 Projects
| 프로젝트명 | 설명 | 역할 | 기간 | 구분 | 비고 |
|------------|-------|------|------------------|--------------------------|--------------------------------------|
| **[Busy Bee](https://github.com/kimdobbang/samsungSDS_BusyBee)** | AI 기반 업무 메일 의도 분류 및 업무 인텔리전스 자동화 서비스. 삼성 SDS 기업 연계 프로젝트 | BE, AWS, IoT | 2024.10.14 ~ 2024.11.22 | SSAFY | 기업연계프로젝트 우수상(전국), 팀장 선발 |
| **[캐치캐치! 시즌아레나](https://github.com/kimdobbang/Catch-SeasonArena)** | 각 사계절에 따른 자연물을 수집하고 실시간 배틀하는 모바일 도감 및 게임 | FE | 2024.08.19 ~ 2024.10.11 | SSAFY | 특화프로젝트 우수상(권역) |
| **[EVERSTAR](https://github.com/kimdobbang/EVER-STAR)** | 추모공간과 힐링퀘스트, 편지 작성을 통해 펫로스 증후군 극복 및 일상회복 지원 서비스 | BE | 2024.07.08 ~ 2024.08.16 | SSAFY | 공통프로젝트 우수상(권역) |
| **[Finyam](https://github.com/kimdobbang/11finalPJT)** | 금융 데이터를 활용한 금융정보 통합플랫폼 웹 애플리케이션. 개인 맞춤형 서비스 제공 | BE & Data | 2024.05.16 ~ 2024.05.24 | SSAFY | SSAFY 1학기 기말 프로젝트 |
| **[AI 기반 실시간 졸음운전 예방 시스템]()** | 실시간 컴퓨터 비전 객체 탐지 프로젝트 | AI | 2023.07.12 ~ 2023.09.11 | 홍익대학교 빅데이터 개발자 양성과정 | - |
